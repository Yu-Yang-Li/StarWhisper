...
- 预训练模型: transformer_classifier_model_1117_50obs
...
# 预训练模型目录
PRETRAINED_MODEL_DIR = BASE_DIR / "train_models/transformer_classifier_model_1117_50obs"
# 微调数据集
from split_utils import load_split_feature_bundle, to_transformer_train_bundle  # noqa: E402

# 微调后的模型保存目录
FINETUNED_MODEL_DIR = (
    BASE_DIR / "train_models/transformer_classifier_model_1117_50obs_finetuned"
)
