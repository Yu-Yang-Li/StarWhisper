...
PRETRAINED_DIR = BASE_DIR / "train_models/transformer_e2e_model_50obs_matched"
MODEL_DIR = BASE_DIR / "train_models/transformer_e2e_model_finetuned_varlen_matched"
...
def train_finetune() -> None:
    ...
    if not ckpt.is_file():
        raise FileNotFoundError(f"缺少 {ckpt}，请先运行 train_transformer_e2e_50obs_matched.py")
    ...
    config = [
        ...
        "aligned_with: finetune_transformer_1117_50obs.py",
