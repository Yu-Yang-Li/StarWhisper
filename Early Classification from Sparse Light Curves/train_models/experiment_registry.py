...
EXPERIMENTS: List[Experiment] = [
    Experiment(
        ...
        "varlen",
        "train2 手工特征",
        TRAIN_MODELS / "xgboost_full",
        [
            TRAIN_MODELS / "xgboost_full/results/test_metrics.json",
        ],
    ),
    Experiment(
        "xgb_1121",
        ...
        "1121",
        "train2_1121 手工特征",
        TRAIN_MODELS / "xgboost_reduced",
        [
            TRAIN_MODELS / "xgboost_reduced/results/test_metrics.json",
        ],
    ),
    Experiment(
        "tf_feat_50obs",
        ...
        "50obs",
        "train4 手工特征, ~250M",
        TRAIN_MODELS / "transformer_feat_50obs_pretrain",
        [
            TRAIN_MODELS / "transformer_feat_50obs_pretrain/results/test_metrics.json",
            TRAIN_MODELS / "transformer_feat_50obs_pretrain/results/metrics.txt",
        ],
    ),
    Experiment(
        "tf_feat_finetune",
        ...
        "varlen",
        "train2 手工特征, ~250M",
        TRAIN_MODELS / "transformer_feat_varlen_finetune",
        [
            TRAIN_MODELS / "transformer_feat_varlen_finetune/results/test_metrics.json",
            TRAIN_MODELS / "transformer_feat_varlen_finetune/results/metrics.txt",
        ],
    ),
    Experiment(
        "tf_feat_scratch",
        ...
        TRAIN_MODELS / "transformer_feat_varlen_scratch",
        [
            TRAIN_MODELS / "transformer_feat_varlen_scratch/results/test_metrics.json",
            TRAIN_MODELS / "transformer_feat_varlen_scratch/results/metrics.txt",
        ],
    ),
    Experiment(
        "e2e_tf_small_50",
        ...
        "50obs",
        "原始时序 (3,50), ~11M",
        TRAIN_MODELS / "e2e_transformer_50obs_pretrain",
        [TRAIN_MODELS / "e2e_transformer_50obs_pretrain/results/test_metrics.json"],
    ),
    Experiment(
        "e2e_tf_small_ft",
        ...
        "varlen",
        "原始时序 3-30, ~11M",
        TRAIN_MODELS / "e2e_transformer_varlen_finetune",
        [TRAIN_MODELS / "e2e_transformer_varlen_finetune/results/test_metrics.json"],
    ),
    Experiment(
        "e2e_tf_matched_50",
        ...
        "50obs",
        "原始时序 (3,50), ~227M",
        TRAIN_MODELS / "e2e_transformer_50obs_matched_pretrain",
        [TRAIN_MODELS / "e2e_transformer_50obs_matched_pretrain/results/test_metrics.json"],
    ),
    Experiment(
        "e2e_tf_matched_ft",
        ...
        "varlen",
        "原始时序 3-30, ~227M",
        TRAIN_MODELS / "e2e_transformer_varlen_matched_finetune",
        [TRAIN_MODELS / "e2e_transformer_varlen_matched_finetune/results/test_metrics.json"],
    ),
    Experiment(
        ...
        TRAIN_MODELS / "e2e_transformer_varlen_matched_scratch",
        [
            TRAIN_MODELS
            / "e2e_transformer_varlen_matched_scratch/results/test_metrics.json"
        ],
    ),
    Experiment(
        "rnn_e2e_varlen",
        ...
        "varlen",
        "原始时序 3-30, ~0.2M",
        TRAIN_MODELS / "lstm_varlen",
        [TRAIN_MODELS / "lstm_varlen/results/test_metrics.json"],
    ),
]
