...
消融用途：与 finetune_transformer_e2e_matched.py 对照，量化 50 点预训练贡献。
...
from transformer_e2e_matched import (
    D_FF,
    D_MODEL,
    DROPOUT,
    N_HEADS,
...
MODEL_DIR = BASE_DIR / "train_models/transformer_e2e_model_varlen_matched_scratch"
...
def train_scratch() -> None:
    ...
    config = [
        ...
        "ablation_vs: finetune_transformer_e2e_matched.py",
