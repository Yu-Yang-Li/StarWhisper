...
入口说明:
  本文件末尾会调用 benchmark_inference_unified.main()，逻辑以 unified 为准。
...
TRANSFORMER_MODEL_DIR = BASE_DIR / "train_models/transformer_classifier_model_1117"
...
# Transformer模型参数（根据transformer_classifier_model_1117的配置）
...
class TransformerClassifier(nn.Module):
    """Transformer分类器模型（匹配transformer_classifier_model_1117的结构）"""
...
if __name__ == "__main__":
    from benchmark_inference_unified import main as unified_main
