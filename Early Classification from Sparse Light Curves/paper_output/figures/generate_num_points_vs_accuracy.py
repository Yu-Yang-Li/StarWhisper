...
def main() -> None:
    xgb_full = pd.read_csv(BASE / "xgboost_optuna_1117/results/num_points_vs_accuracy.csv")
    xgb_reduced = pd.read_csv(
        BASE / "xgboost_optuna_1121/results/less_feature_num_points_vs_accuracy.csv"
    )
    e2e_ft = pd.read_csv(
        BASE / "transformer_e2e_model_finetuned_varlen_matched/results/num_points_vs_accuracy.csv"
    )
    lstm = pd.read_csv(BASE / "rnn_e2e_model_varlen/results/num_points_vs_accuracy.csv")
